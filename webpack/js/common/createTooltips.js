...
export default function createTooltips() {
  ...
  tooltip_text(
    "#work-experience",
    "Work Experience:",
    "<ul><li>— <b>Current:</b> Studio Apt, 3 years</li><li>— <b>Nelson Cash:</b> Sr. Designer, 6 years</li><li>— <b>Doejo:</b> Sr. Designer, 1 year</li><li>— <b>Smith Brothers Advertising:</b> Designer, 1 year</li><li>— <b>Mind Over Media:</b> Designer, 1 year</li></ul>"
  );
